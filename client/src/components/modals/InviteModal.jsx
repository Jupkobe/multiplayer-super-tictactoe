...
export default function InviteModal({ roomId, isOpen }) {
  ...
  return (      
    ...
    <div className="flex flex-col items-center justify-center w-full px-2 py-4 border border-black rounded sm:w-80">
      ...
      <form className='flex gap-2'>
        <input onClick={copyToClipboard} value={window.location.href} readOnly className='p-1 px-2 text-lg leading-none text-center border border-black rounded-md shadow-sm outline-none hover:cursor-pointer sm:w-52 shadow-black'/>
      </form>
